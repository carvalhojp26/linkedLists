...
\renewcommand{\familydefault}{\sfdefault}
  ...
  % Hyperlinks
    ...
    \hypersetup{%
      ...
      citecolor=blue,%
      unicode,%
      pdftitle={Trabalho-\/\+EDA 2023/2024},%
      pdfsubject={Documentação do trabalho de fim de periodo da disciplina de Estrutura de Dados Avançados.}%
    }
